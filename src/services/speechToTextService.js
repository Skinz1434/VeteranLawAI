...
export class SpeechToTextService {
  ...
  detectSpeakerChange(transcript) {
    ...
    const hasIndicator = speakerIndicators.some(indicator => lowerTranscript.includes(indicator))
...
[00:02:12] John Johnson: Yes, I've been in therapy at the VA Medical Center for two years. My psychiatrist has diagnosed me with PTSD and recommended Total Disability Individual Unemployability due to my inability to maintain employment.`,
        ...
        summary:
          'Attorney consultation regarding PTSD claim with discussion of combat stressors, current symptoms, and functional impairment. Multiple VA legal terms and medical terminology identified.',
      },
      {
...
[00:01:25] Dr. Martinez: Based on your history and current presentation, you meet the diagnostic criteria for PTSD. I will recommend a 70% disability rating with consideration for Individual Unemployability due to your occupational impairment.`,
        ...
        summary:
          'C&P examination for PTSD service connection. Veteran reports combat trauma and current symptoms consistent with PTSD diagnosis. Examiner recommends 70% rating with potential TDIU.',
      },
    ]
   ...
   */
  getSupportedFormats() {
    return ['audio/wav', 'audio/mp3', 'audio/m4a', 'audio/webm', 'audio/ogg', 'audio/flac']
  }
  ...
  validateAudioFile(file) {
    ...
    if (!supportedFormats.includes(file.type)) {
      throw new Error(
        `Unsupported file format: ${file.type}. Supported formats: ${supportedFormats.join(', ')}`
      )
    }
