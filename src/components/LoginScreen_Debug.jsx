...
const LoginScreen = () => {
  ...
  const { signInWithGoogle, signIn, createAccount } = authContext;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Debug Info */}
        <div className="mb-4 p-2 bg-yellow-500/20 border border-yellow-500/30 rounded text-xs text-yellow-300">
          Debug: Auth functions available: {signInWithGoogle ? 'Yes' : 'No'}
        </div>
