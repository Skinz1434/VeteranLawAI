...
const Button = React.forwardRef(
  (
    ...
    const variants = {
      primary:
        'bg-gradient-to-r from-cyan-500 to-blue-600 text-white hover:from-cyan-400 hover:to-blue-500 shadow-glow',
      secondary:
        'bg-slate-700/50 text-white hover:bg-slate-700/70 border border-slate-600 hover:border-slate-500',
      outline:
        'bg-transparent text-cyan-400 border border-cyan-400/50 hover:bg-cyan-400/10 hover:border-cyan-400',
