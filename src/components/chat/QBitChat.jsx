  ...
  const [messages, setMessages] = useState([
    {
      ...
      type: 'ai',
      content:
        "👋 Hello! I'm QBit, your AI-powered VA legal assistant. I can help you with case research, claim guidance, legal precedents, and much more. How can I assist you today?",
      timestamp: new Date(),
      suggestions: [
    ...
    >
      <div className={`flex max-w-[85%] ${isAI ? 'flex-row' : 'flex-row-reverse'}`}>
        ...
        >
          ...
          {/* Timestamp */}
          <div className={`text-xs mt-2 opacity-70 ${isAI ? 'text-slate-400' : 'text-cyan-100'}`}>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div
              className="absolute -bottom-10 -left-10 w-16 h-16 bg-purple-500/10 rounded-full blur-xl animate-pulse"
