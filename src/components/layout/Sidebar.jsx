  ...
  const navigationItems = [
    {
      ...
      path: '/',
      icon: Target,
      gradient: 'from-cyan-600/80 via-cyan-700/80 to-cyan-800/80',
    ...
    },
    {
      ...
      path: '/camera-ocr',
      icon: Camera,
      gradient: 'from-emerald-600/80 via-emerald-700/80 to-emerald-800/80',
    ...
    },
    {
      ...
      icon: Database,
      gradient: 'from-blue-600/80 via-blue-700/80 to-blue-800/80',
    ...
    },
    {
      ...
      path: '/claim-guidance',
      icon: FileText,
      gradient: 'from-purple-600/80 via-purple-700/80 to-purple-800/80',
    ...
    },
    {
      ...
      icon: Mic,
      gradient: 'from-green-600/80 via-green-700/80 to-green-800/80',
    ...
    },
    {
      ...
      path: '/case-research',
      icon: Search,
      gradient: 'from-indigo-600/80 via-indigo-700/80 to-indigo-800/80',
    ...
    },
    {
      ...
      path: '/analytics',
      icon: BarChart3,
      gradient: 'from-violet-600/80 via-violet-700/80 to-violet-800/80',
  ...
  const bottomItems = [
    {
      ...
      path: '/settings',
      icon: Settings,
      gradient: 'from-gray-600/80 via-gray-700/80 to-gray-800/80',
    ...
    },
    {
      ...
      path: '/help',
      icon: HelpCircle,
      gradient: 'from-teal-600/80 via-teal-700/80 to-teal-800/80',
