...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="fixed top-1/2 left-1/2 w-48 h-48 bg-gradient-to-r from-emerald-500/3 to-teal-500/3 rounded-full blur-xl animate-pulse" style={{ animationDelay: '4s' }} />
      ...
      <div className="fixed pointer-events-none">
        ...
        <div className="absolute bottom-32 left-32 w-24 h-24 bg-gradient-to-r from-purple-400/5 to-pink-400/5 rounded-full blur-xl animate-pulse" style={{ animationDelay: '3s' }} />
      </div>
    </div>
  )
}
