...
export default function PageShell({ header, children, className = '' }: PageShellProps) {
  return (
    <div className={`min-h-screen relative overflow-hidden ${className}`}>
      ...
      />
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 rounded-full blur-3xl animate-pulse z-0" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-full blur-2xl animate-pulse z-0" style={{ animationDelay: '2s' }} />
